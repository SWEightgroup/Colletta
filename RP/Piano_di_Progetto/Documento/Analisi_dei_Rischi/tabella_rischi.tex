...
Creazione di più milestone, in modo da poter più facilmente ripianificare in caso di errori. Nel caso si verifichi il rischio di un ritardo, verrà valutato se ridistribuire alcuni compiti o riorganizzare la pianificazione.
   ...
   \barra        
    ...
    B-002 &
\textbf
   {Divergenze per la Technology Baseline}&
È possibile che la scelta delle tecnologie da utilizzare per la Technology Baseline sia fonte di micro-conflitti interni. 
   &
   Probabilità: \newline \textbf{Media}\newline
   Gravità: \newline \textbf{Bassa}\\
   ...
   Contromisure&
   \multicolumn{3}{p{13.2cm}}{
   Il \RdP{} cercherà di mediare e di trovare una soluzione che soddisfi tutte le parti.
   Nel caso in cui, tale mediazione non fosse possibile si effettuerà una votazione.    	
   Il voto del \RdP{}, in presenza di una parità nella votazione delle scelte tecnologie, avrà un peso maggiore rispetto a quello degli altri componenti.
   }\\
   \barra    
