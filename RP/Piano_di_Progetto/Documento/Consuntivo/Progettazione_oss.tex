...
%\end{figure}
Tali ridistribuzioni orarie lasciano invariato il costo preventivato in quanto non modificano le ore per ruolo e per componente del gruppo presentati al Committente, al contempo consentono però di:
\begin{itemize}
