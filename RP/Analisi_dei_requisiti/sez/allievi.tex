...
\begin{itemize}
	...
	\item[•]\textbf{Descrizione}: l'attore visualizza l'analisi grammaticale della frase inserita;
	...
	\item[•]\textbf{Flusso degli eventi}:l'attore corregge in maniera automatica la frase, le correzione viene mostrata all'attore. L'analisi è effettuata in modo automatico dalla liberia Freeling di pos-tagging.
\end{itemize}
