...
\item UC 1.1.2 - Inserimento nome utente;
...
\item[•]\textbf{Precondizione}: l’utente non è autenticato e il valore della lingua dell'applicativo è basato sulla geolocalizzazione dell'utente o sull'ultima scelta effettuata;
...
\subsubsection{UC 1.2.9 - Selezione lingua applicativo}
\begin{itemize}
	\item[•]\textbf{Attori}: Utente non autenticato;
