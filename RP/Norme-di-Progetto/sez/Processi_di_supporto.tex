...
Per creare un test ci si dovrà posizionare all'interno della cartella \textit{components} e creare la cartella \textit{\_\_tests\_\_}, se non presente, per testare il file HelloWorld.jsx il file di test sarà chiamato HelloWorld.\textbf{test}.jsx .
\begin{verbatim}
	it('sums numbers', () => {
...
\end{verbatim}
Il comando \textit{expect} verifica che i parametri siano uguali, vedi: \href{https://jestjs.io/docs/en/expect.html#content}{ API Reference: "Expect"}.
