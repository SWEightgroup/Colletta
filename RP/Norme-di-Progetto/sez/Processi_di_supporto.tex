...
Per creare un test ci si dovrà posizionare all'interno della cartella \textit{src} e creare la cartella \textit{\_\_tests\_\_}, se non presente, per testare il file HelloWorld.jsx il file di test sarà chiamato HelloWorld.\textbf{test}.jsx . \\
\begin{verbatim}
	it('sums numbers', () => {
