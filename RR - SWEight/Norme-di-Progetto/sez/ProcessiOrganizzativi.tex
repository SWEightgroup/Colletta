...
\end{itemize}
\subsection{Gestione delle milestone}
...
\newline
La decisione finale spetta comunque al Responsabile di Progetto, che dopo aver valutato l'impatto di qualsiasi modifica al piano ed aver controllato che ciò non comporti l'impossibilità nel raggiungere gli obiettivi prefissati nei tempi stabiliti, potrà decidere di attuarla.
