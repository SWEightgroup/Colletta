...
\item \textbf{T}: è la tipologia del verbale che si divide in interna ed esterna;
...
\item Quando inizia la stesura del documento (In progress), l'owner:
	...
	\end{enumerate}
\item Finita l'attività di scrittura l'owner crea un {pull request}\ped{G} con (Needs review):
	\begin{enumerate}
