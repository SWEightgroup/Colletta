...
\begin{table}[H]	
	\begin{center}
	    \begin{tabular}{C{4cm}C{1cm}C{3,5cm}}
			...
			Analista & 10 & \euro \space  250,00 \\
			Progettista & 125 & \euro \space  2.750,00 \\
			Programmatore & 116 & \euro \space  1.740,00 \\
			Verificatore & 145 & \euro \space  2.175,00 \\
			\textbf{Totale} & \textbf{416} & \textbf{\euro \space  7.415,00} \\
		\end{tabular}
