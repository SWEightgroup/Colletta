...
\begin{table}[H]	
	\begin{center}
	    \begin{tabular}{C{4cm}C{1cm}C{3,5cm}}
			...
			\\
			Responsabile & 35 & \euro \space  1.050,00 \\
			Amministratore & 30 & \euro \space  600,00 \\
			Analista & 22 & \euro \space  550,00 \\
			Progettista & 258 & \euro \space  5.676,00 \\
			Programmatore & 160 & \euro \space  2.400,00 \\
			Verificatore & 319 & \euro \space  4.785,00 \\
			\textbf{Totale} & \textbf{824} & \textbf{\euro \space  15.061,00} \\
		\end{tabular}
