...
\begin{table}[H]	
	\begin{center}
	    \begin{tabular}{C{4cm}C{1cm}C{3,5cm}}
			...
			\\
			Responsabile & 15 & \euro \space  450,00 \\
			Amministratore & 10 & \euro \space  200,00 \\
			Analista & 5 & \euro \space  125,00 \\
			Progettista &  & \space \\
			Programmatore & 44 & \euro \space  660,00 \\
			Verificatore & 102 & \euro \space  1.530,00 \\
			\textbf{Totale} & \textbf{176} & \textbf{\euro \space  2.965,00} \\
		\end{tabular}
