...
\Who{SWEight} % Your name

\Title{} % Your title, leave blank for no title

\authordetails{
	\hspace*{\fill}SWEightGroup@gmail.com\\ % Your email address
	\hspace*{\fill}Torre Archimede, 35131, Padova(PD)
}
...
%----------------------------------------------------------------------------------------
%
\logo{../template/img/logoSWEight.png} % Logo filename, your logo should have square dimensions (i.e. roughly the same width and height), if it does not, you will need to adjust spacing within the HEADER STRUCTURE block in structure.tex (read the comments carefully!)

\headerlineone{Ingegneria del Software} % Top header line, leave blank if you only want the bottom line

\headerlinetwo{Gruppo SWEight} % Bottom header line
