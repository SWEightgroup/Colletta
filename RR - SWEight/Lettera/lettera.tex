...
\newcommand{\NdPv}{\emph{NormeDiProgetto\_v1.0.0}}
\newcommand{\SdFv}{\emph{StudioDiFattibilità\_v1.0.0}}


\name{Sebastiano Caccaro} % used as signature, if no signature is specified

\signature{Sebastiano Caccaro\\ Responsabile del gruppo SWEight}

\date{Padova, 11 Gennaio 2019} % if no date specified, today's date is used 
