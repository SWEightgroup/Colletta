...
\subsubsection{UC 1.3 - Registrazione utente}
\begin{figure}[H]
	\centering
...
\begin{itemize}
	...
	\item[•]\textbf{Estensioni}:
	\begin{enumerate}
		\item UC 1.3.1 - Visualizzazione messaggio errore dato presente;
		\item UC 1.3.2 - Visualizzazione messaggio errore password diverse
	\end{enumerate}
\end{itemize}

\subsubsection{UC 1.3.1 - Visualizzazione messaggio errore dato presente}
\begin{itemize}
	\item[•]\textbf{Attori}: Utente non registrato;
...
\subsubsection{UC 1.3.2 - Visualizzazione messaggio errore password diverse}
\begin{itemize}
	\item[•]\textbf{Attori}: Utente non registrato;
...
\subsubsection{UC 1.3.3 - Inserimento nome utente}
\begin{itemize}
	\item[•]\textbf{Attori}: Utente non registrato;
	\item[•]\textbf{Descrizione}: L’utente inserisce un nome utente durante la registrazione;
	\item[•]\textbf{Precondizione}: L’utente non è registrato;
...
\subsubsection{UC 1.3.4 - Inserimento email istituzionale}
\begin{itemize}
	\item[•]\textbf{Attori}: Utente non registrato;
...
\subsubsection{UC 1.3.5 - Inserimento password}
\begin{itemize}
	\item[•]\textbf{Attori}: Utente non registrato;
	\item[•]\textbf{Descrizione}: L’utente inserisce una password durante la registrazione;
	\item[•]\textbf{Precondizione}: L’utente non è registrato;
...
\subsubsection{UC 1.3.6 - Inserimento conferma password}
\begin{itemize}
	\item[•]\textbf{Attori}: Utente non registrato;
...
\subsubsection{UC 1.3.7 - Inserimento data di nascita}
\begin{itemize}
	\item[•]\textbf{Attori}: Utente non registrato;
