...
\item[•]\textbf{Postcondizione}: L'allievo visualizza la {dashboard}\ped{G} e può vederne tutte le componenti;
...
\item[•]\textbf{Precondizione}: L'allievo visualizza la propria {dashboard}\ped{G};
