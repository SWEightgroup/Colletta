...
\begin{itemize}
\item[•]\textbf{Attori}: Allievo;
\item[•]\textbf{Descrizione}: L'allievo visualizza un elenco di frasi consigliate dal sistema come esercizi, oppure ricerca una frase in particolare;
\item[•]\textbf{Precondizione}: L'allievo si è autenticato;
...
\begin{itemize}
	...
	\begin{enumerate}
		\item UC 2.2.6.1 - Visualizzazione errori testo inserito.
	\end{enumerate}
\end{itemize}
