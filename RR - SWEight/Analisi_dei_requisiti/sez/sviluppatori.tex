...
\begin{figure}[H]
	...
	\caption{Caso d'uso 4.8}\label{fig:480}
\end{figure}
\begin{itemize}
\item[•]\textbf{Attori}: Sviluppatore;
...
\item[•]\textbf{Flusso degli eventi principale}:  Lo sviluppatore seleziona l'opzione di scaricamento e ottiene un file contenete il modello.
\end{itemize}
...
\begin{figure}[H]
	...
	\caption{Caso d'uso 4.9}\label{fig:490}
\end{figure}
\begin{itemize}
	\item[•]\textbf{Attori}: Sviluppatore;
