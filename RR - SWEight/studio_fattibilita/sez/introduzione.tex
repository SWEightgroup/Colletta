...
Lo scopo di questo documento è quello di descrivere in dettaglio le motivazioni che hanno spinto alla scelta del \textit{capitolato}\ped{G} C2 (Colletta: piattaforma raccolta dati di analisi di testo).\\ Sono inoltre presenti anche gli studi di fattibilità dei capitolati che sono stati scartati, mostrando in questo caso le motivazioni.
