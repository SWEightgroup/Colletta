...
\item[•]Il componente custom\ped{G} specifico per la gestione del personale che si occuperà di inoltrare i messaggi alla persona più idonea in quel determinato momento.
\end{itemize}
...
\item[•] The twelve-factor app, una metodologia per la realizzazione di \textbf{software-as-service}\ped{G};
\item[•] \textbf{Docker}: per l’istanziazione di
tutti i componenti;
\item[•] Strumenti per il testing;
\item[•] Utilizzo di un'architettura \textbf{REST};
