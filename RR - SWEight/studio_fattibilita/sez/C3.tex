...
Il capitolato ha per oggetto lo sviluppo di un plug-in di Grafana, scritto in linguaggio JavaScript. Questo crea da un file .json la rete Bayesiana e permette di associare dei valori ai \texttt{nodi}\ped{G}, a seconda dei dati prelevati dal flusso di monitoraggio.
