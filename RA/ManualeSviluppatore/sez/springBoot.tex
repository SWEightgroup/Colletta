This section is intended to make the developer understand the inner workings of the \textit{Colletta} backend, and to allow him or her to add more functionality to the software package.
...
\end{figure}
The figure describes how the backend architecture process an HTTP request through: 
\begin{itemize}
\item \textbf{Controller}: presentation layer, for more information see §\ref{sec:Controller}.
\item \textbf{Service}: service layer, for more information see §\ref{sec:Service}. 
\item \textbf{Repository}: persistence layer, for more information see §\ref{sec:Repository}. 
\end{itemize}
