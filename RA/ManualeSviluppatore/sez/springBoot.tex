...
\subsection{Testing}	
To start the test it is necessary to give the \texttt{mvn test} command 	inside the \textit{Backend} folder, this previous Maven installation startthe tests, static and unit, and shows a report of the tests that are performed.\\
