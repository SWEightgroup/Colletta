...
Per gestire il ciclo di vita dei documenti, deve essere utilizzato il servizio di tasks offerto da Asana, come descritto nella sezione 5.? gestione dell'infrastruttura.
\begin{enumerate}
...
\item I \textit{Verificatori} assegnati controllano il documento decidendo se:
	\begin{enumerate}
	 	...
	 	\item Non accettarlo e rimetterlo in "In Progress".
	\end{enumerate}
...
\begin{enumerate}
	...
	\item Non approvarlo, fornendo le opportune motivazioni spostandolo in "To Do";
\end{enumerate}
