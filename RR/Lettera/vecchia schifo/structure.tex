...
\address{
	...
	\hspace{-0.0\textwidth} % Horizontal position of the author details block, increase to move left, decrease to move right
	\vspace{-0.08\textheight} % Move the date and letter content up for a more compact look
}
...
\renewcommand{\opening}[1]{
	{\centering\fromaddress\vspace{0.10\textheight} \\ % Print the header and from address here, add whitespace to move date down
	\hspace*{\fill}{Padova, 11 Gennaio 2019} % Print today's date, remove \today to not display it
