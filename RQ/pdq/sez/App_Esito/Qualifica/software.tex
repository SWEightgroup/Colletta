...
\paragraph{MS001 - Numero di metodi}\mbox{}\\[0,3cm]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\linewidth]{sez/App_Esito/Qualifica/graph/numeroMetodiCruscotto.pdf}
        \caption{Media metodi per classe}
    \end{figure}
...
\paragraph{MS002 - Numero di parametri}\mbox{}\\[0,3cm]
    \begin{table}[H]
        ...
        \begin{tabular}{ccccccc}
            ...
            \textcolor{white}{\textbf{Codice}} &
            \textcolor{white}{\textbf{File analizzati}} &
            \textcolor{white}{\textbf{Metodi con 5-8 parametri}}&
            \textcolor{white}{\textbf{Metodi con 8 o piu parametri}}&
            \textcolor{white}{\textbf{Riscontro}}\\
            \textbf{MS001} & 44 & 1 & 0 & \textcolor{YellowOrange}{Accettabile}\\
        \end{tabular}
        \caption{Media metodi per classe}
    \end{table}
    \begin{figure}[H]
...
\paragraph{MS003 - Funzioni di interfaccia per package}\mbox{}\\[0,3cm]
    \begin{table}[H]
        ...
        \begin{tabular}{ccccccc}
            \rowcolor{greySWEight}
            \textcolor{white}{\textbf{MS003}} &
            \textcolor{white}{\textbf{File analizzati}} &
            \textcolor{white}{\textbf{Valore}}&
            \textcolor{white}{\textbf{Riscontro}}\\
            \textbf{MS001} & 44 & 1.23 & \textcolor{ForestGreen}{Ottimale}\\
        \end{tabular}
        \caption{Media metodi per classe}
    \end{table}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\linewidth]{sez/App_Esito/Qualifica/graph/interfacciaPerP.pdf}
        \caption{Interfacce}
    \end{figure}
