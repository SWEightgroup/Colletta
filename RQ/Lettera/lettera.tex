...
\name{Damien Ciagola} % used as signature, if no signature is specified

\signature{Damien Ciagola\\ Responsabile del gruppo SWEight}

\date{Padova, 12 Aprile 2019} % if no date specified, today's date is used 
