...
\begin{figure}[H]
\centering
\includegraphics[width=17cm]{img/Panoramicaconext12.png} 
\caption{Panoramica registrazione}\label{fig:1}
\end{figure}
...
\subsubsection{Panoramica recupero credenziali}
\begin{figure}[H]
	\centering
	\includegraphics[width=14cm, keepaspectratio]{img/panoramicaUC15.png} 
	\caption{panoramica recupero credenziali}
\end{figure}
