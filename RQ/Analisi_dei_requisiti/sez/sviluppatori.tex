...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm, keepaspectratio]{img/panmod411.png} 
	\caption{Caso d'uso UC 4.11:  Panoramica modifica dati utente per Sviluppatore}\label{fig:Panoramica modifica dati utente}
\end{figure}
