...
\end{itemize}
\newpage
\paragraph{Panoramica feature branch}\mbox{}\\ \label{sec:FB}
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm,keepaspectratio]{img/Feature.png}
\caption{Diagramma di sequenza feature branch}
\end{figure}
