...
\end{center}
Ulteriori convenzioni adottate o sostituite sono:\\
...
Spring Data MongoDB è un subframework di Spring Data, lo scopo di Spring Data è quello di fornire un accesso semplice ai database seguento il modello di programmazione di Spring. Rende più facile l'accesso a database relazionali e non.\\
Nel nostro caso il progetto Spring Data MongoDB prevede un integrazione con il database documentale MongoDB.\\
La chiave centrale sono i modelli POJO per interagire con il database, questi permettono permettono di interrogare e scrivere in modo semplice
il database senza dover ricorrere alla sintassi di MongoDB ma effettuando tutte le operazione da Spring. 