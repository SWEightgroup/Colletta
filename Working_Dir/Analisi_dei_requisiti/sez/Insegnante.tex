...
\begin{itemize}
	...
	\item[•] \textbf{Descrizione}: l’insegnante accede alla propria dashboard dove può vedere i suoi dati, le frasi che ha assegnato agli alunni, il numero e i nomi degli studenti che ha. Può effettuare modifiche agli esercizi e ai suoi dati personali.
	\item[•] \textbf{Precondizione}: l'insegnante si è autenticato;
	\item[•] \textbf{Postcondizione}: l'insegnante visualizza il profilo personale e visualizza il numero di allievi, le frasi che ha inserito, i suoi dati e le soluzioni spedite dagli allievi.
...
\begin{itemize}
	...
	\item[•] \textbf{Descrizione}: L'attore rivece un messaggio di errore poichè la libreria (FreeLing) di PoS-tagging non è disponibile; 
...
\begin{itemize}
	...
	\item[•] \textbf{Flusso degli eventi}: l'insegnante si è autenticato e è entrato nel suo profilo.
\end{itemize}
...
\begin{itemize}
	...
	\item[•] \textbf{Flusso degli eventi}: l'insegnante si è autenticato e è entrato nel suo profilo nella sezione storico frasi inserite.
\end{itemize}
...
\begin{itemize}
	...
	\item[•] \textbf{Flusso degli eventi}: l'insegnante si è autenticato ed è entrato nel profilo.
\end{itemize}
...
\begin{itemize}
	...
	\item[•] \textbf{Flusso degli eventi}: l'insegnante ha iniziato la procedura di modifica esercizio e ha modificato i tag automatici e la visibilità.
\end{itemize}
...
\begin{itemize}
	...
	\item[•] \textbf{Flusso degli eventi}: l'insegnante ha iniziato la procedura di modifica esercizio e ha modificato i tag automatici, la visibilità e ha eliminato la soluzione alternativa, se presente.
\end{itemize}
...
\begin{itemize}
	...
	\item[•] \textbf{Flusso degli eventi}: l'insegnante si è autenticato e si trova nel suo profilo personale e sta visualizzando gli esercizi precedentemente inseriti.
\end{itemize}