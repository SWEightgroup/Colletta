...
\end{flushleft}
Il Dockerfile che contiene di la configurazione per la compilazione e l'installazione dell'applicativo. Per eseguire questo file eseguire il comando:
\begin{center}
	\texttt{\# docker build --tag=freeling:alpha .}
\end{center}
Il comando genererà un'immagine che sarà eseguibile con il comando: \\
